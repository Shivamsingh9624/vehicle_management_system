<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        move_uploaded_file($_FILES['file']['tmp_name'],"vehicle_pictures/".$_FILES['file']['name']); 
        ...
        <div class="col-md-6"> 
            ...
            <form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
                ...
                <br> 
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>VID No</b></span>
                  <input id="vehchesis" type="text" class="form-control" name="vehchesis" placeholder="VID No" required>
                </div>
                <br> 
                ...
                <br>
                 ...
                 <div class="input-group">
                  <span class="input-group-addon"><b>Description</b></span>
                     <textarea rows="5" id="draddress" type="text" class="form-control" name="vehdescription" placeholder="Address" required> </textarea>
