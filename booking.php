<?php
    ...
    $query= "SELECT  `your_name`, `email` FROM `user` WHERE username='$username'";
            ...
            <div class="col-md-6">
                <form action="bookingaction.php" method="post">
                    ...
                    <div class="input-group">
                      ...
                      <input id="name" type="text" class="form-control" name="name" value="<?php echo $username; ?>"  required>
                    </div>
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" name="req_time" id="req_time" class="form-control" placeholder="Time the car is needed"/>
                    ...
                    <div class="input-group">
                      ...
                      <input id="return_date" type="text" class="form-control" name="return_date" placeholder="Day the car will be returned" required>
                      <input type="text" name="return_time" id="return_time" class="form-control" placeholder="Time the car is Returned"/>
                    </div>
